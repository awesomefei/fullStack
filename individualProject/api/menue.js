...
var contries = [
    { contryId: 1, contry: 'USA', lacation: ' Redmond Town Center, 7530 164th Ave NE A112, Redmond, WA 98052', phone: '(111)111-1111' },
    { contryId: 2, contry: 'China', lacation: ' Redmond Town Center, 7530 164th Ave NE A112, Redmond, WA 98052', phone: '(222)222-2222' },
    { contryId: 3, contry: 'UK', lacation: ' Redmond Town Center, 7530 164th Ave NE A112, Redmond, WA 98052', phone: '(333)333-1111' }
];
var cars = [
    {
        id: 1,
...
router.get('/menue/:id', function (req, res, next) {
    var id = parseInt(req.params['id']);
    var menue = findCar(id);
    if (menue) {
        res.json(menue);
    }
    else {
